...
function prepareGameField() {
	...
	var snake_field=document.getElementById('snake-field');
		snake_field.innerHTML="";
		snake_field.appendChild(game_table); // Добавление таблицы
}
...
function startGame() {
	...
	block_timer = setInterval(createBlock, 10000);
}
...
function move() {
	...
	// 3) Змейка не врезалась в препятствие
 ...
 */
 function gameScore(score){
	 var scorePlayer = document.getElementById("game-score");
	 scorePlayer.innerText = "Счёт: " + score;
 }
...
function createBlock(){
	...
	while(!blockCreated) { //пока препятствие не создали
